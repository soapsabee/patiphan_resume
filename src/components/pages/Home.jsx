...
export const Home = () => {
  return (
    <div id="aboutme" className="flex flex-wrap items-center h-3/5 p-40  md:space-x-10 pt-32 md:pt-52 ">
      ...
      <div className="bg-[url('./assets/images/img_profile.jpg')] bg-hero bg-no-repeat bg-cover bg-center   rounded-full h-64 w-64 border-2 relative">
        ...
        <div className='border-2 w-1 absolute top-[100%] left-[120px] h-[250%] '>
